...
"""This file includes a function that implements an ERM algorithm for the hypothesis class H.
    
    The function accepts as input: 
    (a) A sorted list xs=[X1,...,Xn]
    (b) The respective labeling ys =[Y1,...Yn]
    (c) k - the number of intervals
    
    The function returns a list of up to k intervals and their error count on the given sample.
    These Intervals have the smallest empirical error count possible from all choices of k intervals or less.
    """
